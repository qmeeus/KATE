...
def train(args):
    ...
    if args.noise == 'gs':
        ...
        raise TypeError("Invalid argument: {}".format(args.noise))
...
def main():
    parser = argparse.ArgumentParser('Trainer script for KATE')
    ...
    parser.add_argument('-ne', '--n_epoch', type=int, default=100, help='num of epochs (default 100)')
    ...
    parser.add_argument('--noise', type=str, default='gs', choices=['gs', 'sp', 'mn'], help='noise type: gs for Gaussian noise, sp for salt-and-pepper or mn for masking noise')
